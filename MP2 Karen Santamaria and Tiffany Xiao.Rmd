...
```
##Repository Link
Link to our repository which shows the issues tab and version control
https://github.com/sanmakaren/sds192-mp2
...
## Inferences
We predicted that candidates with the least percent difference would lose the election, however, we found that the majority in the "Least Percent Difference in Campaign Performance" did win the election, although, the lowest ranking candidate did loose. This may be due to the filtering we did in order to increase relevence of the candidates that were displayed on the graphs.  From the graphs we created we began to infer that the time between the primary and general election is not as essential as the time before the primary because even candidates that did not have many general votes compared to their primary votes were still able to win, however, further analysis is needed to confirm this.

We also looked to identify possible causes for rapid increases or decreases, such as the case with John Koster who experienced a very low increase in votes from general to primary elections because of a scandal dealing with his inappropriate response to a question about rape. Thomas Massie on the other hand was well-liked throughout his campaign and received endorsements from established Republicans and conservative organizations such as Ron Paul, Gun Owners of America, and Young American for Liberty which we belive contributed to his success as a candidate.
